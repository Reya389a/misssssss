...
function send() {
   ...
   console.log(charAt3);
    ...
    remove_charAt1 = word.replece(charAt1, "_");
    remove_charAt2 = remove_charAt1.replece(charAt2, "_");
    remove_charAt3 = remove_charAt2.replece(charAt3, "_");
...
function check()
{
    ...
    anawer = get_answer.toLowerCase();
    console.log("Respuesta en minucula  = " + anawer);
    if(anawer == word)
    {
        
        if(anawer_turn == "player1")
        {
